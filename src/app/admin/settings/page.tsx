...
export default function SettingsPage() {
  const [form, setForm] = useState({ store_name: "NAYRO", whatsapp_number: "212689363596", instagram: "https://instagram.com/nayro", delivery_fee: 30, free_delivery_threshold: 50 })
